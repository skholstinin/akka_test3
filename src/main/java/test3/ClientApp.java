...
import test3.helpers.CsvHelper;
import test3.models.City;
...
public class ClientApp {
    ...
    public static void main(String[] args) {
        ...
        clientCsv.requestLevelFutureBased(Optional.of("Paris"), success -> Jackson.unmarshaller(City[].class).unmarshal(success.entity(),
        ...
        client.hostLevel(Optional.of("Istanbul"), success ->
                success.first().get().entity().getDataBytes().runFold(ByteString.emptyByteString(), ByteString::concat, client.getMaterializer())
                        .handle((byteString, f) -> {
                            if (f != null) {
